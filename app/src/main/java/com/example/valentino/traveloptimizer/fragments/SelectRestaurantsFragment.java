 ...
 */
public class SelectRestaurantsFragment extends Fragment {
    ...
    public SelectRestaurantsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_select_restaurants, container, false);
    ...
    private void getPlaces() {
        ...
        Call<List<Place>> call = apiInterface.getAllPlaces(currTrip.getCity(), "Restaurant");
