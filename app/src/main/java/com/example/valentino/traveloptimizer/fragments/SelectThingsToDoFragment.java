...
public class SelectThingsToDoFragment extends Fragment {
    ...
    public SelectThingsToDoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_select_things_to_do, container, false);
